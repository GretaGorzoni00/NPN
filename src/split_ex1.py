...
if __name__ == "__main__":
	...
	for it in range(_NFOLDS):
		...
		write_csv(f"data/data_set/ex_1/pseudo/full/ex1_other_train_{it}.csv", train_file)
		write_csv(f"data/data_set/ex_1/pseudo/full/ex1_other_test_{it}.csv", test_file)