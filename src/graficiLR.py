...
csvs = [
    "data/output/metrics/other/full/BERT_ex1_UNK_other__avg_metrics.csv",
    "data/output/metrics/other/full/BERT_ex1_CLS_other__avg_metrics.csv",
    "data/output/metrics/other/full/BERT_ex1_PREP_other__avg_metrics.csv"
]
